 ...
 * Return a single Promise that fulfills when all the Promises
 * pass to it have been fulfilled. It rejects with the reason
 * of the first promise that rejects or with the error
 * caught by the first argument, if that argument has caught 
